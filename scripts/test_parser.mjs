...
const INSTA_ACCOUNT_BRANDS = {
  'mude_official': '무드', 'holikaholika_official': '홀리카홀리카',
  'ipknofficial': '입큰', 'naming.cosmetic': '네이밍',
  'peripera_official': '페리페라', 'a.chicosmetics': '에이치아이',
  'romand_official': '롬앤', 'clio_cosmetics': '클리오',
  'etudehouse': '에뛰드', 'innisfree_official': '이니스프리',
  'laneige_official': '라네즈', 'moumou_official_': '모우모우',
  '2an_official': '투안',
};
